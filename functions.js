...
function mobileShow() {
  ...
  if (x.style.display == "block") {
    ...
    var m = document.getElementsByClassName("mobileIconActive");
    m[0].className = "mobileIcon";

  }

  else {
    x.style.display = "block";
    var m = document.getElementsByClassName("mobileIcon");
    m[0].className = "mobileIconActive";
  }
}
...
function showSection(n) {
  ...
  for(var i=0; i< all.length; ++i){
      ...
      else {document.getElementById(all[i].id).style.display="block";
      }
  }
}
